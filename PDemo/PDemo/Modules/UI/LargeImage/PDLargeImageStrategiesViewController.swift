//
//  PDLargeImageStrategiesViewController.swift
//  PDemo
//
...
class PDLargeImageStrategiesViewController: PDTableViewController {
    ...
    override func viewDidLoad() {
        ...
        caseSections = [
            [
                ["UIKit-setImage:":"PDLargeImageViewController"],
                ["CATiledLayer":"PDLargeImageViewController"],
                ["苹果推荐的分片比列裁剪方式":"PDLargeImageViewController"]
            ]
        ]
    }
